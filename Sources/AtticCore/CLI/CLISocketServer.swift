...
/// These helper functions provide Swift-friendly wrappers for the C fd_set macros.
/// fd_set is used with select() to monitor file descriptors for I/O readiness.
