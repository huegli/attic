...
It has been replaced by the Python FastMCP implementation in `Sources/AtticMCP-Python/`.
...
See `Sources/AtticMCP-Python/` and `.mcp.json` for the active MCP server configuration.
