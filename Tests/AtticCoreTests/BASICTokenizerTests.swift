...
final class BASICTokenizerTests: XCTestCase {
    ...
    func testVariableNameEncoding() {
        ...
        XCTAssertEqual(encoded, [0x58 | 0x80])  // 'X' = $58, with high bit = $D8
